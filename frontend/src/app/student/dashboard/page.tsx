      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            <div className="glass-card p-10 rounded-[45px] bg-gradient-to-br from-primary/10 via-transparent to-transparent border-primary/10 space-y-8">
              <h3 className="text-xl font-bold tracking-tight">Biometric Shield</h3>
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-xs text-white/50 leading-relaxed font-medium">Class codes ensure that only authorized students can sync with a specific academic session.</p>
                </div>
              </div>
              <button className="w-full py-5 rounded-[28px] bg-white/5 border border-white/10 text-xs font-black uppercase tracking-widest hover:bg-white/10 transition-all text-white/60 hover:text-white">
                Download Privacy Log
              </button>
            </div>
